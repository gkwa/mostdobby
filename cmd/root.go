...
to quickly create a Cobra application.`,
	...
	// 	fmt.Println("Hello from mostdobby!")
	// },
}
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.mostdobby.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".mostdobby" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigType("yaml")
		viper.SetConfigName(".mostdobby")
	}
